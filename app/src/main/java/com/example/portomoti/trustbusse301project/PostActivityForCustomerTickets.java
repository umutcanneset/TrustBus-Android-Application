...
public class PostActivityForCustomerTickets extends ArrayAdapter<String> {
    ...
    public PostActivityForCustomerTickets(ArrayList<String> from, ArrayList<String> objectId, ArrayList<String> where, ArrayList<String> date, Activity context){
//String ----> Date
